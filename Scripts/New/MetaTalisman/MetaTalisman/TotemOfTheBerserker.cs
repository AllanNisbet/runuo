...
{
	public class TotemOfTheBerserker: BaseMetaTalisman
	{
        private Mobile m_Owner;
				
		[Constructable]
		public TotemOfTheBerserker()
		
        {
            Name = "<BASEFONT COLOR=#CC0000>Totem of the Berserker";
			Hue = 1257;
			Weight = 0.0;
			Stackable = false;
        ...
        public TotemOfTheBerserker(Serial serial)
            : base(serial)
        {}
		...
		public override bool OnEquip(Mobile from)
        {
            ...
            {
                m_Owner = from;
                //this.Name = m_Owner.Name.ToString() + "'s Totem of the Berserker";
        ...
        {
            Console.WriteLine("Test Points in BaseMetaTalisman: (" + points + ")");
